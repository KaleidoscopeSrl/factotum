...
class ProductCategory extends Model
{
	...
	public function products() {
		return $this->belongsToMany('Kaleidoscope\Factotum\Models\Product', 'product_product_category');
	}

	public function parent() {
		return $this->belongsTo( 'Kaleidoscope\Factotum\Models\ProductCategory', 'parent_id');
	}

	public function childs() {
		return $this->hasMany('Kaleidoscope\Factotum\Models\ProductCategory','parent_id','id') ;
	}
	...
	public function getTotalProductsAttribute()
	{
		...
		return DB::table('product_product_category')
					->join('products', 'product_product_category.product_id', '=', 'products.id')
