...
class Order extends Model
{
	...
	public function products() {
		return $this->belongsToMany('Kaleidoscope\Factotum\Models\Product', 'order_product')
					->withPivot('product_variant_id', 'quantity', 'product_price', 'tax_data');
	}

	public function discount_code() {
		return $this->hasOne('Kaleidoscope\Factotum\Models\DiscountCode', 'id', 'discount_code_id');
	}
	...
	public function sendNewOrderNotifications()
	{
		if ( file_exists( app_path('Models/User.php') ) ) {
			$customer = \App\Models\User::with('profile')->find( $this->customer_id );
		} else {
